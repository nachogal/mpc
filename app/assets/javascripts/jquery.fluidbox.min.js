	...
	var methods = {
		init : function(options) {
			var defaults = {  
				...
				overlay_width: 180,		// The overlay element's width. Set to 0 to use the same as 'width'
				overlay_height: 180,		// The overlay element's height. Set to 0 to use the same as 'height'
				...
				fade_speed: 300, 		// Effect ducation for the 'fade' effect only
